...
const RecruiterLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Interview Templates', href: '/recruiter/templates', icon: DocumentDuplicateIcon },
    { name: 'Candidate Scheduler', href: '/recruiter/scheduler', icon: CalendarIcon },
    { name: 'Candidate Reviews', href: '/recruiter/reviews', icon: UserGroupIcon },
        ...
        >
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <span className="text-xl font-bold text-primary-600">AI Interview Assistant</span>
            </div>
